"""Config flow for Hyundai Ioniq 5 (2025) integration."""
...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Required(CONF_REGION, default=1): vol.In(REGIONS),  # Default to Europe (1) for Austrian users
        vol.Required(CONF_BRAND, default=2): vol.In(BRANDS),  # Default to Hyundai (2) for Ioniq 5
    }
)
